...
public class AllureLifecycle {
    ...
    private static DatabaseResultsWriter getDefaultWriter() {
        final Properties properties = PropertiesUtils.loadAllureProperties();
        final String mongoBaseUrl = properties.getProperty("allure.results.mongo_base_url", "mongodb://localhost:27017");
        final String mongoDbName = properties.getProperty("allure.results.mongo_db_name", "allure");
        final String mongoCollectionName = properties.getProperty("allure.results.mongo_collection_name", "allure-results");
        return new DatabaseResultsWriter(mongoBaseUrl, mongoDbName, mongoCollectionName);
    }
